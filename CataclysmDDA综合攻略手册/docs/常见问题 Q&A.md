...
各种技能的入门（1至3级）一般可以通过制造菜单中的「练习」来获得，部分练习需要对应的指南书才能解锁；
...
互动类技能同理，但操控装置、社交需要频繁实践；

计算机学可以通过指南书+有超级黑客管家的u盘练习至十级；
...
**Q：不同伐木等级的工具在「砍树」和「树干劈成原木」过程中有什么区别？**

**A**：工具的「伐木」功能等级决定了伐木速度。具体来说，使用1至4级伐木工具伐木，分别需要30、15、7.5、3.75分钟。

## 45、木板产量

**Q：原木劈成木板的产率与什么有关？**

**A**：一块原木最多劈成十块木板，与执行者的制造技能等级有关。劈木板过程固定需要20分钟，与「木材锯切」等级无关。

## 46、生物体型

**Q：鸡笼、木制宠物笼、宠物包，载具上的宠物柜、牲畜笼都有什么区别？**

**A**：各种生物根据其体积大小，分为「tiny」（小于7.5升），「small」（小于46.25升），「medium」（小于108升），「large」（小于483.75升），「huge」（其他）五类；

鸡笼只能捕捉「tiny」或更小的生物，木制宠物笼、宠物包可以捕捉「small」或更小的生物，宠物柜可以捕捉「medium」及以下，牲畜笼可以捕捉「huge」及以下的生物（其实就是所有生物）。

## 47、木炭产量

**Q：炭窑的木炭产量受什么因素影响？**

**A**：受炭窑种类、填入燃料的体积和制造等级影响；石头炭窑的容积为250升，金属炭窑的容积为200升；

石头炭窑的木炭产量约为「80+4×制造等级」×燃料体积(升)，金属炭窑的木炭产量约为「160+4×制造等级」×燃料体积(升)，这也是对金属炭窑较高造价的回报。