...
**A**：各种生物根据其体积大小，分为tiny（小于7.5升），small（小于46.25升），medium（小于108升），large（小于483.75升），huge（其他）五类；

鸡笼只能捕捉tiny或更小的生物，木制宠物笼、宠物包可以捕捉small或更小的生物，宠物柜可以捕捉medium及以下，牲畜笼可以捕捉huge及以下的生物（其实就是所有生物）。